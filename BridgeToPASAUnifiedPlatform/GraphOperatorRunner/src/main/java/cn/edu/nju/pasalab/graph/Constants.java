...
public class Constants {
    ...
    public static final String RUNMODE_SPARK_GRAPHX = "SparkGraphX";
    ...
    public static final String ARG_INPUT_EDGE_CSV_FILE_PATH = "inputEdgeCSVFilePath";
    ...
    public static final String ARG_INPUT_VERTEX_CSV_FILE_PATH = "inputVertexCSVFilePath";
    public static final String ARG_RUNMODE = "runMode";
    public static final String ARG_RUNMODE_CONF_FILE =  "runModeConfFile";
    public static final String ARG_VERTEX_PROPERTY_NAMES = "vertexPropertyNames";
    public static final String ARG_EDGE_PROPERTY_NAMES = "edgePropertyNames";
    public static final String ARG_OUTPUT_VERTEX_CSV_FILE_PATH = "outputVertexCSVFilePath";
    public static final String ARG_OUTPUT_EDGE_CSV_FILE_PATH = "outputEdgeCSVFilePath";
    public static final String ARG_VERTEX_PROPERTY_COLUMNS = "vertexPropertyColumns";
    public static final String ARG_VERTEX_NAME_COLUMN = "vertexNameColumn";
