...
public class Constants {
    ...
    public static final String RUNMODE_SINGLE_NODE = "SingleNode";
    public static final String RUNMODE_HADOOP_GRAPH_COMPUTER = "HadoopGraphComputer";
    public static final String RUNMODE_GS_GRAPH_COMPUTER = "GSGraphComputer";
    public static final String RUNMODE_GRAPHX = "GraphX";
